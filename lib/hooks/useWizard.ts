...
const JOIN_COPY = [
  ...
  { title: 'Pick a project',       subtitle: 'Browse open projects and select the one that excites you.' },
  { title: 'Send your intro',      subtitle: "Introduce yourself and tell the team why you want to join." },
];
